...
public class MessageUtil {
    ...
    public String senRadomCode(String phoneNum, String code) throws Exception{
        ...
        formParams.add(new BasicNameValuePair("pszMsg", messageProperties.getPszMsg().replace("xxxxxx",code)));
