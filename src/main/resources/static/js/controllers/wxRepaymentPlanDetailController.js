 ...
 */
app.controller('wxRepaymentPlanDetailController',['$scope', '$state', '$http', '$stateParams', function($scope,$state, $http, $stateParams) {
    ...
    function init(){
        $http.get('/contracts/'+$stateParams.applyNum+'/repayDetail').success(function(result){
